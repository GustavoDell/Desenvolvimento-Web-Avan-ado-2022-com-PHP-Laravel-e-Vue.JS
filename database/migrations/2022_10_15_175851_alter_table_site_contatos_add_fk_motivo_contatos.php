...
class AlterTableSiteContatosAddFkMotivoContatos extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement('update site_contatos set motivo_contatos_id = motivo_contato'); //esse metodo estatico permite execultar uma query no banco de dados

        //criando a fk e remover a coluna motivo contato
        Schema::table('site_contatos', function (Blueprint $table) {
